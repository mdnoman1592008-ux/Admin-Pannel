    ...
    return GlassCard(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 20),
          GlowButton(
            label: _sending ? 'Broadcasting...' : 'Broadcast FCM Push',
        ...
        child: Center(
          child: Column(
            ...
            children: [
              ...
              Text('No FCM messages logged in Firestore collection "notifications"',
                  style: AppTextStyles.h3()),
              const SizedBox(height: 8),
              Text('Broadcast a notification to record FCM push telemetry.',
