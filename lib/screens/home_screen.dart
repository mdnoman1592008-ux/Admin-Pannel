        ...
        children: [
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                GestureDetector(
                  onLongPress: widget.onOpenAdmin,
                  child: const Row(
                    children: [
                      Icon(
                            ...
                            Row(
                              children: [
                                LiquidButton(
                                  ...
                                  onPressed: () => widget.onSelectMovie(heroMovie),
                                ),
          ...
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 20.0),
            child: Text(
              _selectedCategory == 'ALL' ? 'Trending Now' : 'Trending in $_selectedCategory',
              style: const TextStyle(
                fontSize: 20,
                fontWeight: FontWeight.bold,
                color: Colors.white,
          ...
          // Anime & Series Cinema Collection
          const Padding(
            padding: EdgeInsets.symmetric(horizontal: 20.0),
            child: Text(
